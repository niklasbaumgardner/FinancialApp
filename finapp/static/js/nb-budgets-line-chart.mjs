...
class BudgetsLineChartChartJS extends BaseChart {
  #firstTransactionDate;
  #lastTransactionDate;
  ...
  makeChart() {
    ...
    for (let date of this.dates) {
      allBudgets.data.push(this.currentDatasets[date]["-1"] ?? 0);
    }

    datasets.push(allBudgets);
...
customElements.define("nb-budgets-line-chart-chartjs", BudgetsLineChartChartJS);
